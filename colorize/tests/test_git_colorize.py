...
class TestMain:
    ...
    def setUp(self, mocker):
        mocker.patch('colorize.git_colorize.COLOR_TAGS', ['mock_color'])

        self.mock_Color = mocker.patch('colorize.git_colorize.Color')
        self.mock_Color.side_effect = ['colored_author',
                                       'colored_code']

        self.mock_BorderlessTable = mocker.patch('colorize.git_colorize.BorderlessTable')

        self.mock_stdin_lines = mocker.patch('colorize.git_colorize.stdin_lines')
    ...
    def test_ascii(self):
        ...
        self.mock_Color.assert_any_call('{mock_color}e7ab9458 (John Doe        2017-05-13 16:24:56 -0700    1){/mock_color}')
    ...
    def test_unicode(self):
        self.mock_stdin_lines.return_value = ['e7ab9458 (\u0134\xf0\u0127\xf1 \xd0\xf0\xeb        2017-05-13 16:24:56 -0700    1) #!/usr/bin/env python',
                                              ]
        main()
